...
namespace ImGui
{
	...
	IMGUI_API bool OwOButtonXD(const char* label, const ImVec2& size_arg, bool inuse, ImGuiButtonFlags flags);
	//IMGUI_API bool          SliderBehavior(const ImRect& frame_bb, ImGuiID id, float* v, float v_min, float v_max, float power, int decimal_precision, ImRect& grab_pos, ImGuiSliderFlags flags = 0, const char* label = "", char* value = "");
